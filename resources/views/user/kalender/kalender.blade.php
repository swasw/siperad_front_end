                    ...
                    <form action="{{ route('user.peminjaman-ruang.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="mata_kuliah" id="mata_kuliah" placeholder="Mata Kuliah" value="{{ old('mata_kuliah') }}" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="dosen" id="dosen" placeholder="Nama Dosen" value="{{ old('dosen') }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="prodi" class="form-label">Program Studi</label>
                                <input type="text" class="form-control" name="prodi" id="prodi" placeholder="Program Studi" value="{{ old('prodi') }}" required>
                            </div>
                            <div class="mb-3">
                                <label for="angkatan" class="form-label">Angkatan</label>
                                <input type="number" class="form-control" name="angkatan" id="angkatan" placeholder="Tahun Angkatan" value="{{ old('angkatan') }}" required>
                            </div>
                            <div class="mb-3">
