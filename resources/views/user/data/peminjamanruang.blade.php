                    ...
                    <tbody>
                        @forelse ($data as $peminjamanruang)
                            <tr>
                                ...
                                <td>{{ $peminjamanruang['mata_kuliah'] ?? '-' }}</td>
                                <td>{{ substr($peminjamanruang['jamx']['jam'] ?? '00:00', 0, 5) }}</td>
                                <td>{{ substr($peminjamanruang['jamy']['jam'] ?? '00:00', 0, 5) }}</td>
                                <td>{{ $peminjamanruang['dosen'] ?? '-' }}</td>
                                <td>{{ $peminjamanruang['prodi'] ?? '-' }}</td>
                                <td>{{ $peminjamanruang['angkatan'] ?? '-' }}</td>
